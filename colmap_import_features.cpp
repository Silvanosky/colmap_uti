...
int main(int argc,char** argv)
{
    ...
    aIm1.SetCameraId(camera.camera_id);
    aIm1.CamFromWorldPrior() = Rigid3d(Eigen::Quaterniond(0.1, 0.2, 0.3, 0.4),
    ...
    aIm2.SetCameraId(camera.camera_id);
    aIm2.CamFromWorldPrior() = Rigid3d(Eigen::Quaterniond(0.1, 0.2, 0.3, 0.4),
                                       Eigen::Vector3d(0.1, 0.2, 0.3));
