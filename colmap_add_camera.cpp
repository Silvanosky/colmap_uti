...
int main(int argc, char** argv) {
    std::cout << "colmap modify intrinsics in the database and reconstruction "
                 "(optional)"
              << "\n";
    ...
    Camera aNewCam =
        Camera::CreateFromModelName(1, camera_name, aFocal, aSzX, aSzY);
    ...
    aNewCam.camera_id = database.WriteCamera(aNewCam);
